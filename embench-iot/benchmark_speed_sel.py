...
############################################################################
# This script is a modified version of benchmark_speed.py written by SoCLab.
# --bench "benchmark list" option is added.
# <benchmark list> is a string containing one or more programs in the following:
#     aha-mont64, cubic, huffbench, minver, nettle-aes, nsichneu, qrduino, slre, statemate, wikisort
#     crc32, edn, matmult-int, nbody, nettle-sha256, picojpeg, sglib-combined, st, ud
#
# If a user can simulate aha-mont64, cubic and huffbench by executing the following command:
#  benchmark_speed_sel.py --target-module run_spike --absolute --bench "aha-mont64 cubic huffbench"
# 
# If --bench "benchmark list" is not provided, all the benchmark programs are simulated.
...
def get_common_args():
    ...
    parser.add_argument(
        '--bench',
        type=str,
        help='Specify source code to benchmark',
    )
...
# This is added by SoCLab.
def find_benchmarks_sel(args):
    ...
    # print("ARGS in find_benchmarks_sel: ")
    # print(args)
    ...
    if args != None:
      ...
      # print("DIRLIST in find_benchmarks_sel: ")
      # print(dirlist)
...
def main():
    ...
    # Find the benchmarks
    benchmarks = find_benchmarks_sel(args.bench)
