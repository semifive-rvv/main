...
def build_parser():
    ...
    parser.add_argument( 	# Added by SoCLab
        '--rv32-gcc-spike',
        action='store_true',
        help='Run RISC-V GCC version comparison benchmarks'
    )
...
def main():
	...
	# Added by SoCLab
    if args.rv32_gcc_spike:
        runsets.append(rv32_gcc_spike_runset)

    if not runsets:
        print("ERROR: No run sets specified")
        print("For benchmarking by using Spike, option is --rv32-gcc-spike")
        sys.exit(1)
